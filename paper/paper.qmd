...
ggplot(plot_data, aes(x = quarter_year)) +
  geom_line(aes(y = test, color = "Total Active Applications"), size = 1.2) +
  geom_line(aes(y = test, color = "Seniors' Applications"), linetype = "dashed", size = 1.2) +
  scale_color_manual(values = c("blue", "red")) +
...
ggplot(plot_data, aes(x = Year_Quarter)) +
  geom_point(aes(y = household_no_dependents, color = "Household without Dependents"), size = 1.2) +
  geom_point(aes(y = household_with_dependents, color = "Household with Dependents"), linetype = "dashed", size = 1.2) +
  scale_color_manual(values = c("blue", "red")) +
...
# Create a line plot
ggplot(plot_data, aes(x = quarter_year)) +
  geom_point(aes(y = Inactive_Cancelled, color = "Inactive/Cancelled"), size = 1.2) +
  geom_point(aes(y = Total_Active_Waiting_List, color = "Total Active Waiting List"), linetype = "dashed", size = 1.2) +
  scale_color_manual(values = c("blue", "red")) +

...
The above @data-overview is an overview of the data. It simulates the first 6 lines of all columns to give the readers an idea of what the data looks like. The complete data consists of 9 columns/variables and 20 lines/quarters of years from quarter 1 2019 to quarter 4 2023.
